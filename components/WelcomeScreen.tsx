...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onImportVideo, onImportFolderSelection }) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center text-center p-8 relative">
      <div className="max-w-xl w-full relative">
        <h1 className="text-6xl font-extrabold tracking-tighter text-slate-900">TLDW</h1>
        <p className="text-slate-500 mt-2 mb-10 text-lg">Too Long; Didn't Watch - Learn from long videos 10x faster</p>
        ...
        >
          ...
          <p className="text-slate-700 font-medium mb-2">Drag & drop your video here</p>
          <p className="text-slate-500 text-sm mb-6">MP4, WebM, OGG, MOV</p>
        ...
        <div className="mt-8 backdrop-blur-md bg-white/30 p-6 rounded-2xl text-left border border-white/30 shadow-lg">
            <h3 className="font-semibold text-slate-900 mb-2">Jump to top insights immediately</h3>
            <p className="text-sm text-slate-600">Upload a local video. We'll generate summaries, key info, and topics for you. All processing is done locally on your machine for complete privacy.</p>
        </div>
      </div>
    </div>
  );
