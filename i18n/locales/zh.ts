...
export const zh: Translations = {
  ...
  modelPlaceholderSystem: (model: string) => `使用系统设置: ${model}`,
  apiKey: "自定义 API 密钥",
  apiKeyPlaceholder: "输入您的 API 密钥以覆盖",
  apiKeyPlaceholderSystem: "正在使用系统设置",
  apiKeyHelpText: "如果提供，这将覆盖系统/环境变量密钥。",
  baseUrl: "基础 URL (可选)",
  baseUrlPlaceholder: "例如 https://generativelanguage.googleapis.com",
  baseUrlPlaceholderSystem: "正在使用系统设置",
  baseUrlHelpText: "使用自定义 API 端点。如果为空，将回退到系统设置或默认值。",
  saveChanges: "保存更改",
  testConnection: "测试连接",
